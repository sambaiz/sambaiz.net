    ...
    return (
      <div>
        ...
        <ul className={classNames(styles.circle_group, styles.clearfix)}>
          <li className={classNames(styles.sns_circle, styles.hatebu)}><span><i className={classNames("fa", styles["fa-hatena"])}></i></span><a data-hatena-bookmark-title={title} href={`http://b.hatena.ne.jp/entry/${url}`}></a></li>
          ...
          <li className={classNames(styles.sns_circle, styles.pocket)}><span><i className={classNames("fa", "fa-get-pocket")}></i></span><a href={`http://getpocket.com/edit?url=${url}&amp;title=${encodeURIComponent(title)}`}></a></li>
        </ul>
      </div>
    )
  }
