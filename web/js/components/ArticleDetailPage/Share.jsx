    ...
    return (
      <div>
        ...
        <ul className={classNames(styles.circle_group, styles.clearfix)}>
          ...
          <li className={classNames(styles.sns_circle, styles.twitter)}><span><i className={classNames("fa", "fa-twitter")}></i></span><a href={`https://twitter.com/share?url=${url}&amp;text=${encodeURIComponent(`${title} - [sambaiz net]`)}`}></a></li>
