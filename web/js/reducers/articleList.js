...
const initialState = {articles: [], loading: false, page: 0, loaded: false}
  ...
  switch (action.type) {
    ...
    case ARTICLE_LIST_SUCCESS:
      return Object.assign({}, state,
        { articles: state.articles.concat(action.response), loading: false, page: action.page, loaded: true })
